...
const focusItems = ['통신사 계정 보호', '명의도용 여부 확인', '보안 업데이트 점검', '수상한 문자와 링크', '민감한 화면 정리']
...
const awarenessCards = [
  ...
  },
  {
    ...
    body: '특히 명의도용방지시스템, 통신사 계정 보호, 업데이트, 수상한 문자와 링크처럼 즉시 실천 가능한 항목에 집중했습니다.'
  }
]
...
const libraryItems = [
  {
    title: '유심 보안 한눈에 보기',
    text: '통신사 계정 보호, 명의도용 확인, 업데이트, 수상한 문자와 링크 주의처럼 지금 바로 적용할 수 있는 것부터 챙기세요.'
  },
  {
    title: '수상한 문자와 링크 구별하기',
    text: '보상 신청, 본인확인, 요금 미납 같은 문구가 와도 문자 속 링크 대신 공식 앱이나 고객센터로 먼저 확인하세요.'
  },
  {
    title: '정기 점검 주기',
